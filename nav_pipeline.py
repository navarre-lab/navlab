...
"""
This pipeline takes a set of Genbank files (.gbff) and outputs an XML file for each strain, comparing it to 
all other strains in the directory.
"""
...
# create fna files and put in the fna directory
...
# create faa files and put in the faa directory_list
